...
class ValidationResult:
    ...
    ``ok`` indicates whether the step succeeded. ``messages`` contains
    any log messages generated during the step and ``metrics`` exposes
    numeric information which may be useful for monitoring.
    """
...
class StepLog:
    ...
    While not utilised directly in the core logic yet, this structure
